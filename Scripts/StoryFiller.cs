public static class StoryFiller
{
    public static StoryNode FillStory()
    {
        ...
        var node6 = CreateNode(
            ...
            new [] {
            "Explore the drawers.",
            "Go back to explore the rest of the objects."}, 6);
        ...
        var node11 = CreateNode(
          ...
          new [] {
            "Explore the objects in the room."}, 11);
    ...
    private static StoryNode CreateNode(string history, string[] options, int indexx)
    {
